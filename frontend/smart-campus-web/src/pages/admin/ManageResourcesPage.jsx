      ...
      <aside className="admin-sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <div className="nav-group">
            ...
            <div className="mini-stats-grid-sidebar">
              ...
              <div className="mini-stat">
                <div className="mini-stat-icon spaces">
                ...
                <div className="mini-stat-info">
                  <span className="stat-num">{stats.rooms + stats.labs + stats.halls}</span>
                  <span className="stat-txt">Spaces</span>
                </div>
              </div>
              <div className="mini-stat">
                <div className="mini-stat-icon equipment">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="2" y="7" width="20" height="15" rx="2" ry="2"></rect><polyline points="17 22 17 2 7 2 7 22"></polyline></svg>
                </div>
                <div className="mini-stat-info">
                  <span className="stat-num">{stats.equipment}</span>
                  <span className="stat-txt">Assets</span>
                </div>
              </div>
            </div>
